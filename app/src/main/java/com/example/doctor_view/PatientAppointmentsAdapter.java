...
public class PatientAppointmentsAdapter extends ArrayAdapter<Appointment> {

    public interface AppointmentClickListener {
        void onBookButtonClick(Appointment appointment);
    }
    ...
    public PatientAppointmentsAdapter(Context context, List<Appointment> appointmentList) {
        super(context, R.layout.patient_appointment_item, appointmentList);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listItem == null) {
            ...
            listItem = LayoutInflater.from(context).inflate(R.layout.patient_appointment_item, parent, false);

            // Initialize the ViewHolder
            holder = new ViewHolder();
            holder.appointmentItemTextView = listItem.findViewById(R.id.appointmentItemTextView);
            holder.bookButton = listItem.findViewById(R.id.bookButton);
        ...
        holder.bookButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (clickListener != null) {
                    clickListener.onBookButtonClick(currentAppointment);
                }
            }
        });
