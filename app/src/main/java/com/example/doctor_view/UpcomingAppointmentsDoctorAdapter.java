...
public class UpcomingAppointmentsDoctorAdapter extends RecyclerView.Adapter<UpcomingAppointmentsAdapter.ViewHolder> {
    private List<Appointment> appointments;

    public UpcomingAppointmentsDoctorAdapter(List<Appointment> appointments) {
    ...
    public UpcomingAppointmentsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UpcomingAppointmentsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UpcomingAppointmentsAdapter.ViewHolder holder, int position) {
